...
/**
 * Manages a Logfire read token. Equivalent to logfire.ApiKey with scopes `["project:read_otlp"]`.
 *
 * ## Example Usage
 *
 * ```typescript
...
export class ReadToken extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ReadTokenState, opts?: pulumi.CustomResourceOptions): ReadToken {
        return new ReadToken(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'logfire:index/readToken:ReadToken';

    /**
     * Returns true if the given object is an instance of ReadToken.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ReadToken {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ReadToken.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: ReadTokenArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ReadTokenArgs | ReadTokenState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ReadTokenState | undefined;
            ...
            const args = argsOrState as ReadTokenArgs | undefined;
        ...
        super(ReadToken.__pulumiType, name, resourceInputs, opts);
    }
}
