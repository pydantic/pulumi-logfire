...
func NewChannel(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("logfire:index/channel:Channel", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetChannel(ctx *pulumi.Context,
	...
	var resource Channel
	err := ctx.ReadResource("logfire:index/channel:Channel", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Whether the channel is active.
func (o ChannelOutput) Active() pulumi.BoolOutput {
