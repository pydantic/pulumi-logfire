...
namespace Pulumi.Logfire
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Logfire.version.txt");
    ...
    internal sealed class LogfireResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public LogfireResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
