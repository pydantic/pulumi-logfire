...
{
    [LogfireResourceType("logfire:index/channel:Channel")]
    public partial class Channel : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("config")]
        public Output<Outputs.ChannelConfig?> Config { get; private set; } = null!;
        ...
        public Channel(string name, ChannelArgs? args = null, CustomResourceOptions? options = null)
            : base("logfire:index/channel:Channel", name, args ?? new ChannelArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Channel(string name, Input<string> id, ChannelState? state = null, CustomResourceOptions? options = null)
            : base("logfire:index/channel:Channel", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class ChannelArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("config")]
        public Input<Inputs.ChannelConfigArgs>? Config { get; set; }
    ...
    public sealed class ChannelState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("config")]
        public Input<Inputs.ChannelConfigGetArgs>? Config { get; set; }
